...
/*** wapiti ***/
const float Essay::WAP_NN[2] = {0.100484137, 0.159069493};
const float Essay::WAP_IN[2] = {0.092357678, 0.13467623};
const float Essay::WAP_DT[2] = {0.061559137, 0.114890853};
const float Essay::WAP_NNS[2] = {0.044510857, 0.097290701};
const float Essay::WAP_JJ[2] = {0.046907242, 0.091709072};
const float Essay::WAP_VB[2] = {0.040295998, 0.075141428};
const float Essay::WAP_PRP[2] = {0.030922645, 0.079946311};
const float Essay::WAP_RB[2] = {0.035254622, 0.070149778};
const float Essay::WAP_VBP[2] = {0.023691416, 0.062131758};
const float Essay::WAP_TO[2] = {0.020197174, 0.045865208};
const float Essay::WAP_CC[2] = {0.019799923, 0.045662945};
const float Essay::WAP_VBZ[2] = {0.015468271, 0.040924271};
const float Essay::WAP_MD[2] = {0.010002384, 0.033209538};
const float Essay::WAP_VBG[2] = {0.008619068, 0.03120198};
const float Essay::WAP_PRP$[2] = {0.005492265, 0.026708295};
const float Essay::WAP_VBN[2] = {0.004700506, 0.021048472};
const float Essay::WAP_VBD[2] = {0, 0.021334341};
const float Essay::WAP_JJR[2] = {0.000389976, 0.017975424};
const float Essay::WAP_NNP[2] = {0, 0.031616588};
const float Essay::WAP_WRB[2] = {0.001336937, 0.011394769};
const float Essay::WAP_CD[2] = {0.000444533, 0.012070537};
const float Essay::WAP_WDT[2] = {0.001248944, 0.009484962};
const float Essay::WAP_WP[2] = {0.000310884, 0.010113128};
const float Essay::WAP_RBR[2] = {0.000277596, 0.008767824};
...
const float Essay::AVG_TO[2] = {0.0202218, 0.045871282};
const float Essay::AVG_AND[2] = {0.011673995, 0.033896595};
const float Essay::AVG_OF[2] = {0.010547538, 0.032746636};
const float Essay::AVG_IN[2] = {0.009780794, 0.031002952};
const float Essay::AVG_A[2] = {0.007817975, 0.031953259};
const float Essay::AVG_IS[2] = {0.007682153, 0.025815327};
const float Essay::AVG_THAT[2] = {0.006897911, 0.024868219};
const float Essay::AVG_PEOPLE[2] = {0.000253842, 0.023590594};
const float Essay::AVG_IT[2] = {0.002789684, 0.018376344};
const float Essay::AVG_ARE[2] = {0.003193345, 0.017429355};
const float Essay::AVG_THEY[2] = {0, 0.020749026};
const float Essay::AVG_FOR[2] = {0.003339458, 0.016249298};
const float Essay::AVG_HAVE[2] = {0.001651582, 0.015343914};
const float Essay::AVG_NOT[2] = {0.002175914, 0.014041662};
const float Essay::AVG_BE[2] = {0.001822417, 0.013764945};
const float Essay::AVG_YOU[2] = {0, 0.019676013};
const float Essay::AVG_MORE[2] = {0.000547114, 0.01255994};
const float Essay::AVG_CAN[2] = {0.00046169, 0.012115358};
const float Essay::AVG_WILL[2] = {0, 0.01367205};
const float Essay::AVG_THEIR[2] = {0, 0.013756034};
const float Essay::AVG_WITH[2] = {0.001212585, 0.011117129};
const float Essay::AVG_WE[2] = {0, 0.014045416};
const float Essay::AVG_AS[2] = {0.000698058, 0.00990436};
const float Essay::AVG_OR[2] = {0.000558729, 0.009689773};
...
const float Essay::AVG_TIME[2] = {0, 0.00889095};
const float Essay::AVG_THERE[2] = {0, 0.008448179};
const float Essay::AVG_BY[2] = {0, 0.008031606};
const float Essay::AVG_SO[2] = {0, 0.007478815};
const float Essay::AVG_BECAUSE[2] = {0, 0.007476802};
const float Essay::AVG_MY[2] = {0, 0.008254657};
const float Essay::AVG_ABOUT[2] = {0, 0.007698908};
const float Essay::AVG_HE[2] = {0, 0.009974934};
